# SUPERADO — Cierre normalización producción/pólizas A&S GT/CO
...
>
> La hoja `Listado producción 2025-2026` debe ignorarse para migración de clientes, pólizas, cobros o cartera. Cualquier conteo o cruce de esta hoja queda solo como ejercicio exploratorio/heurístico y no debe alimentar Firestore LAB, seed demo ni reportes de producción real.
>
...
**Estado original:** cierre documental exploratorio; ahora superado por alcance definitivo financiero.
