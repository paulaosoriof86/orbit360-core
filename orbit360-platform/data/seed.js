...
Orbit.SEED = (function () {
  ...
  const asesores = [
    { id: 'ase001', nombre: 'Valeria Morán', rol: 'Dirección', roles: ['Dirección', 'Admin'], rolDefault: 'Dirección', iniciales: 'PO', color: '#C5162E', metaPrima: 220000, metaRecaudo: 180000, comTipo: 'variable', comPct: 18, shareCom: 60, comModo: 'comision' },
    { id: 'ase002', nombre: 'Diego Marroquín', rol: 'Asesor Sr.', teamId: 't1', iniciales: 'DM', color: '#1f3a5f', metaPrima: 160000, metaRecaudo: 140000, comTipo: 'variable', comPct: 15, shareCom: 55, comModo: 'comision' },
    { id: 'ase003', nombre: 'Lucía Herrera', rol: 'Asesora', teamId: 't1', iniciales: 'LH', color: '#1f8a4c', metaPrima: 140000, metaRecaudo: 120000, comTipo: 'variable', comPct: 12, shareCom: 10, comModo: 'neta' },
    { id: 'ase004', nombre: 'Marco Villatoro', rol: 'Asesor', teamId: 't2', iniciales: 'MV', color: '#c9821b', metaPrima: 120000, metaRecaudo: 100000, comTipo: 'fija', comPct: 10, shareCom: 45, comModo: 'comision' },
  ...
  function asgExtra(nombre, pais, nit) {
    ...
    return {
      ...
      cuentas: [
        { banco: pais === 'GT' ? 'Banco Industrial' : 'Bancolombia', tipo: 'Monetaria', numero: (pais === 'GT' ? '3014' : '5123') + between(1000000, 9999999), moneda: pais === 'GT' ? 'GTQ' : 'COP' }
      ],
      contactos: [
        { nombre: 'Ejecutivo Comercial', area: 'Comercial', tipo: 'Comercial / Técnico', email: 'comercial@' + slug + '.com', tel: (pais === 'GT' ? '+502 ' : '+57 ') + between(3000, 3999) + between(1000, 9999), principal: true, vigencia: 'Vigente', canal: 'WhatsApp' },
        { nombre: 'Mesa Administrativa', area: 'Facturación', tipo: 'Administrativo', email: 'admin@' + slug + '.com', tel: (pais === 'GT' ? '+502 ' : '+57 ') + between(2000, 2999) + between(1000, 9999), vigencia: 'Vigente', canal: 'Correo' },
        { nombre: 'Atención de Siniestros', area: 'Siniestros', tipo: 'Siniestros', email: 'siniestros@' + slug + '.com', tel: (pais === 'GT' ? '+502 ' : '+57 ') + between(1500, 1999) + between(1000, 9999), vigencia: 'Vigente', canal: 'Teléfono' }
      ],
      docs: [
        { id: 'doc-tar-' + slug, nombre: 'Tarifario vigente.pdf', cat: 'Tarifas' },
        { id: 'doc-for-' + slug, nombre: 'Formulario de emisión Auto.pdf', cat: 'Formularios' },
        { id: 'doc-com-' + slug, nombre: 'Brochure comercial.pdf', cat: 'Comercial' }
      ],
      docsRequeridos: [
  ...
  const aseguradoras = [
    ...
    Object.assign({ id: 'asg07', nombre: 'Robledal Seguros', color: '#15803d', pais: 'GT', ramos: ['Auto', 'Vida', 'Daños'], comisionDefault: 12, comisiones: {}, comisionesProd: {} }, asgExtra('Robledal Seguros', 'GT'), { vinculada: false }),
    Object.assign({ id: 'asg08', nombre: 'GyT Compañía de Seguros', color: '#1d4ed8', pais: 'GT', ramos: ['Auto', 'Gastos Médicos', 'Fianzas'], comisionDefault: 12, comisiones: {}, comisionesProd: {} }, asgExtra('GyT Compañía de Seguros', 'GT'), { vinculada: false }),
    Object.assign({ id: 'asg09', nombre: 'Metropolitana Seguros', color: '#b91c1c', pais: 'GT', ramos: ['Auto', 'Hogar', 'Transporte'], comisionDefault: 12, comisiones: {}, comisionesProd: {} }, asgExtra('Metropolitana Seguros', 'GT'), { vinculada: false }),
    Object.assign({ id: 'asg10', nombre: 'Surandina Seguros', color: '#0369a1', pais: 'CO', ramos: ['Auto', 'Vida', 'Salud', 'Daños'], comisionDefault: 14, comisiones: {}, comisionesProd: {} }, asgExtra('Surandina Seguros', 'CO'), { vinculada: false }),
    Object.assign({ id: 'asg11', nombre: 'Altiplano Seguros', color: '#15803d', pais: 'CO', ramos: ['Vida', 'Hogar', 'Cumplimiento'], comisionDefault: 14, comisiones: {}, comisionesProd: {} }, asgExtra('Altiplano Seguros', 'CO'), { vinculada: false }),
    Object.assign({ id: 'asg12', nombre: 'Continental Seguros', color: '#1e3a8a', pais: 'CO', ramos: ['Auto', 'RC', 'Transporte'], comisionDefault: 13, comisiones: {}, comisionesProd: {} }, asgExtra('Continental Seguros', 'CO'), { vinculada: false })
  ];
  // Gate default-deny de Cotizador: cada ramo existente en el demo se marca HABILITADO
  // explícitamente (ramosHabilitados[ramo].cotizador = true) para que el prototipo
  // siga siendo demostrable; la ausencia de esta marca en un ramo nuevo significa NO disponible.
  aseguradoras.forEach((a, i) => {
    a.ramosHabilitados = a.ramosHabilitados || {}; (a.ramos || []).forEach(r => { a.ramosHabilitados[r] = { cotizador: true }; }); a.ramosDetalle = a.ramosDetalle || {}; a.actividad = a.actividad || [];
    // portales: al menos una de cada 3 declara acceso disponible (ejemplo demostrable, sigue siendo "declarado por el equipo", no una conexión real)
    a.portales = [{ nombre: 'Portal principal', tipo: 'Portal general', url: a.portal, pais: a.pais, estadoAcceso: (i % 3 === 0) ? 'Acceso disponible' : 'Pendiente de conexión segura', responsable: (a.contactos[0] || {}).nombre || '', ultimaVerificacion: (i % 3 === 0) ? iso(NOW) : '', credentialRef: 'backend_required' }];
  });
  ...
  const novedades = [
    { id: 'nov1', tipo: 'incentivo', titulo: '🏆 Incentivo de junio: bono por 10 pólizas Auto', detalle: 'Cierra 10 pólizas de Auto este mes y gana un bono del 5% adicional sobre comisión.', autor: 'Valeria Morán', fecha: iso(addDays(NOW, -2)), prioridad: true },
  ...
  const cursos = [
    ...
    { id: 'cur2', titulo: 'Fundamentos de Seguros', cat: 'Técnico', emoji: '🛡️', color: '#1f3a5f', desc: 'Ramos, coberturas, prima, deducible y siniestros.', destinatarios: 'equipo', metaLeccion: { porQueExiste: 'Porque asesorar sin dominar los conceptos base (prima, deducible, ramo) genera promesas de cobertura incorrectas.', problemaResuelve: 'Confusión de términos frente al cliente que erosiona la confianza.', sinEsto: 'El asesor no puede explicar con precisión qué cubre y qué no cubre una póliza.', objetivo: 'Manejar con soltura el vocabulario técnico base de seguros.', rol: 'Equipo (todos)', modulo: 'Pólizas, Cotizador', datosLee: 'N/A (curso conceptual)', datosEscribe: 'N/A', accionesPermitidas: 'Explicar coberturas y condiciones al cliente con vocabulario correcto', erroresEvitar: 'Confundir deducible con coaseguro, o prima con suma asegurada', casoPractico: 'Un cliente pregunta la diferencia entre deducible y coaseguro; el asesor responde con un ejemplo numérico.', evidencia: 'Quiz', estado: 'progreso/certificado', actualizado: '2026-07-11' }, lecciones: [
    ...
    { id: 'cur3', titulo: 'Ventas Consultivas', cat: 'Comercial', emoji: '🎯', color: '#1f8a4c', desc: 'Prospección, descubrimiento de necesidades y cierre.', destinatarios: 'equipo', metaLeccion: { porQueExiste: 'Porque prospectar sin criterio llena el pipeline de negocios que nunca cierran.', problemaResuelve: 'Falta de metodología en la conversación de venta.', sinEsto: 'El asesor depende solo de la suerte o el precio para cerrar.', objetivo: 'Aplicar un proceso consultivo: prospección, descubrimiento y cierre.', rol: 'Asesor', modulo: 'Orbit Leads', datosLee: 'Canal de ingreso del prospecto', datosEscribe: 'Notas de descubrimiento en el negocio', accionesPermitidas: 'Calificar prospectos, registrar necesidades detectadas', erroresEvitar: 'Cotizar sin haber hecho preguntas de descubrimiento', casoPractico: 'Un referido llega sin datos claros; el asesor hace 3 preguntas de descubrimiento antes de cotizar.', evidencia: 'Quiz', estado: 'progreso/certificado', actualizado: '2026-07-11' }, lecciones: [
    ...
    { id: 'cur4', titulo: 'Producto: Auto', cat: 'Producto', emoji: '🚗', color: '#c9821b', desc: 'Cobertura, tarifas y argumentos de venta de Auto.', destinatarios: 'equipo', metaLeccion: { porQueExiste: 'Porque Auto es el ramo de mayor volumen y el que más rápido rota (renovación anual).', problemaResuelve: 'Vender solo por precio sin explicar diferencias reales de cobertura.', sinEsto: 'El cliente elige por precio y luego reclama coberturas que no tenía.', objetivo: 'Explicar coberturas de Auto y usarlas como argumento de venta.', rol: 'Equipo comercial', modulo: 'Cotizador, Comparativo', datosLee: 'Tarifas y coberturas por aseguradora', datosEscribe: 'Cotizaciones en el Cotizador', accionesPermitidas: 'Cotizar, comparar y recomendar coberturas de Auto', erroresEvitar: 'Prometer cobertura amplia cuando el cliente cotizó solo RC', casoPractico: 'Cliente compara dos primas de Auto; el asesor explica la diferencia de cobertura, no solo el precio.', evidencia: 'Quiz', estado: 'progreso/certificado', actualizado: '2026-07-11' }, lecciones: [
    ...
    { id: 'cur6', titulo: 'Orbit Leads para Asesores', cat: 'Comercial', emoji: '🎯', color: '#2563a8', desc: 'Domina el pipeline comercial: prospectar, cotizar, negociar y cerrar.', destinatarios: 'Asesor', progreso: 0, certificado: false,
      ...
      metaLeccion: { porQueExiste: 'Porque el asesor necesita dominar su propio pipeline sin depender del equipo de Ops.', problemaResuelve: 'Negocios estancados por falta de seguimiento propio del asesor.', sinEsto: 'Los negocios se pierden por descuido de seguimiento, no por precio.', objetivo: 'Gestionar el pipeline propio de principio a fin en Orbit Leads.', rol: 'Asesor', modulo: 'Orbit Leads', datosLee: 'Etapa y cadencia del negocio', datosEscribe: 'Notas de seguimiento, motivo de pérdida', accionesPermitidas: 'Avanzar etapas, registrar objeciones, marcar ganado/perdido', erroresEvitar: 'Dejar un negocio sin actualizar por semanas', casoPractico: 'Un negocio lleva 10 días en "Propuesta" sin avance; el asesor revisa la cadencia y llama directamente.', evidencia: 'Quiz', estado: 'progreso/certificado', actualizado: '2026-07-11' },
      lecciones: [
    ...
    { id: 'cur7', titulo: 'Finanzas para Directores', cat: 'Finanzas', emoji: '💰', color: '#c9821b', desc: 'Control financiero completo: movimientos, liquidaciones, presupuesto e IA.', destinatarios: 'Dirección', progreso: 0, certificado: false,
      ...
      metaLeccion: { porQueExiste: 'Porque un director sin visión financiera clara no puede tomar decisiones de crecimiento con confianza.', problemaResuelve: 'Confundir facturación (CxC) con caja real disponible.', sinEsto: 'Decisiones de gasto o inversión basadas en cifras infladas.', objetivo: 'Leer el dashboard financiero e identificar desviaciones de presupuesto.', rol: 'Dirección', modulo: 'Finanzas', datosLee: 'Movimientos, CxC/CxP, presupuesto por mes/país', datosEscribe: 'Partidas de presupuesto, ajustes de liquidación', accionesPermitidas: 'Aprobar liquidaciones, editar presupuesto, ver comparativos', erroresEvitar: 'Tratar una CxC facturada como si ya fuera caja disponible', casoPractico: 'El margen operativo baja dos meses seguidos; la Dirección revisa gastos fijos y comisiones antes de decidir.', evidencia: 'Quiz', estado: 'progreso/certificado', actualizado: '2026-07-11' },
      lecciones: [
    ...
    { id: 'cur8', titulo: 'Marketing Digital para Seguros', cat: 'Marketing', emoji: '📣', color: '#6b4ea0', desc: 'Estrategia de contenidos, automatización y medición para intermediarios.', destinatarios: 'Marketing', progreso: 0, certificado: false,
      ...
      metaLeccion: { porQueExiste: 'Porque el marketing de una correduría debe generar leads medibles, no solo presencia en redes.', problemaResuelve: 'Contenido publicado sin estrategia de embudo ni medición de resultado comercial.', sinEsto: 'Se invierte tiempo en piezas que no producen negocio.', objetivo: 'Planificar el calendario por embudo y medir leads generados.', rol: 'Marketing', modulo: 'Orbit Marketing', datosLee: 'Calendario, métricas de piezas publicadas', datosEscribe: 'Piezas de contenido, segmentación, estado de publicación', accionesPermitidas: 'Crear/editar piezas, generar mes con IA, medir resultados', erroresEvitar: 'Publicar solo contenido de oferta (BOFU) sin educar primero', casoPractico: 'El mes tiene 80% contenido de oferta y pocos leads; se rebalancea a 50/30/20 por etapa de embudo.', evidencia: 'Quiz', estado: 'progreso/certificado', actualizado: '2026-07-11' },
      lecciones: [
    ...
    { id: 'cur9', titulo: 'Portal del Cliente', cat: 'Inducción', emoji: '🚪', color: '#0f766e', desc: 'Guía para clientes: cómo usar su portal, ver pólizas, pagar y solicitar gestiones.', destinatarios: 'clientes', progreso: 0, certificado: false,
      ...
      metaLeccion: { porQueExiste: 'Porque un cliente que sabe usar su portal reclama menos y se autoatiende con confianza.', problemaResuelve: 'Clientes que no saben cómo reportar un pago o abrir un reclamo sin llamar al asesor.', sinEsto: 'El equipo recibe consultas repetitivas que el portal ya resuelve.', objetivo: 'Usar el portal para ver pólizas, reportar pagos y solicitar gestiones.', rol: 'Cliente', modulo: 'Portal del Cliente', datosLee: 'Pólizas, recibos y siniestros propios', datosEscribe: 'Reporte de pago, solicitud de gestión, documentos', accionesPermitidas: 'Reportar pago, subir documento, abrir reclamo, escribir al asesor', erroresEvitar: 'Reportar un pago sin adjuntar el comprobante', casoPractico: 'Un cliente paga su recibo y lo reporta en el portal adjuntando la foto del comprobante.', evidencia: 'Quiz', estado: 'progreso/certificado', actualizado: '2026-07-11' },
      lecciones: [
    ...
    { id: 'cur5', titulo: 'Cumplimiento y Confidencialidad', cat: 'Normativa', emoji: '⚖️', color: '#6b4ea0', desc: 'Protección de datos, Habeas Data, secreto profesional y conducta.', destinatarios: 'equipo', progreso: 0, certificado: false,
      ...
      metaLeccion: { porQueExiste: 'Porque el intermediario maneja datos sensibles de clientes (salud, financieros) y su mal uso tiene consecuencias legales.', problemaResuelve: 'Manejo informal de datos personales (correo/WhatsApp personal, bases compartidas).', sinEsto: 'Riesgo de sanciones y pérdida de confianza del cliente.', objetivo: 'Aplicar los principios de protección de datos y confidencialidad en el día a día.', rol: 'Equipo (todos)', modulo: 'Cliente360, Portal', datosLee: 'N/A (curso normativo)', datosEscribe: 'N/A', accionesPermitidas: 'Tratar datos solo dentro de la plataforma y para el fin autorizado', erroresEvitar: 'Enviar bases de clientes por correo o WhatsApp personal', casoPractico: 'Un excolaborador pide la base de clientes "para referencia"; se niega por confidencialidad indefinida.', evidencia: 'Quiz', estado: 'progreso/certificado', actualizado: '2026-07-11' },
      lecciones: [
    ...
    { id: 'cur_master', titulo: 'Curso Maestro Orbit 360 — visión integral', cat: 'Inducción', emoji: '🌐', color: '#C5162E', desc: 'Recorrido completo por toda la plataforma: el ciclo 360, cada módulo, la sincronía en vivo y el valor para el negocio.', destinatarios: 'equipo', progreso: 0, certificado: false,
      ...
      metaLeccion: { porQueExiste: 'Porque entender el ciclo integral (no solo módulos sueltos) es lo que permite usar Orbit 360 con criterio de negocio.', problemaResuelve: 'Uso fragmentado de la plataforma, módulo por módulo, sin ver el ciclo completo.', sinEsto: 'El equipo no aprovecha la sincronía en vivo entre módulos.', objetivo: 'Explicar el ciclo 360 completo y cómo se conectan los módulos entre sí.', rol: 'Equipo (todos)', modulo: 'Toda la plataforma', datosLee: 'N/A (curso integral)', datosEscribe: 'N/A', accionesPermitidas: 'Explicar el flujo completo a un colega o cliente interno', erroresEvitar: 'Tratar cada módulo como un sistema aislado', casoPractico: 'Un cliente cierra un Lead; el equipo explica cómo eso crea el cliente y activa la cadencia de encuestas sin trabajo manual.', evidencia: 'Quiz', estado: 'progreso/certificado', actualizado: '2026-07-11' },
      lecciones: [
