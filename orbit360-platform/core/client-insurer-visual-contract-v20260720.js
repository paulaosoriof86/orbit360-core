...
(function () {
  ...
  function nodeNeedsCanonicalEnhancement(node){if(!node||node.nodeType!==1)return false;if(node.id==='asg-ficha'||node.id==='af-body')return true;if(node.matches&&node.matches('.asg-row[data-cont]:not([data-m1-contact-card="1"]),.asg-row[data-portal]:not([data-m1-portal-card="1"]),.asg-row[data-cta]:not([data-m1-bank-card="1"]),label.ce-l:not([data-m1-read-field="1"])'))return true;return !!(node.querySelector&&node.querySelector('#asg-ficha,#af-body,.asg-row[data-cont]:not([data-m1-contact-card="1"]),.asg-row[data-portal]:not([data-m1-portal-card="1"]),.asg-row[data-cta]:not([data-m1-bank-card="1"]),label.ce-l:not([data-m1-read-field="1"])'));}
