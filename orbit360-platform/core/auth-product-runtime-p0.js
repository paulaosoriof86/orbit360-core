...
(function(){
  ...
  window.Orbit.auth={VERSION:'product-p0-m6-20260730',init:init,user:user,authed:function(){return!!user();},login:function(){return user();},logout:logout,showLogin:showLogin,showApp:showApp,productUser:null,writeAuthorized:false,noLocalSession:true};
})();
