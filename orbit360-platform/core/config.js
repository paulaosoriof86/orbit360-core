...
Orbit.cat = (function () {
  ...
  const DEF = {
    ...
    // listas desplegables, analítica, trazabilidad y estandarización.
    // Estructura: { GT: { "Ramo": [subramos...] }, CO: {...} }
    ramosPais: {
      GT: {
      ...
      CO: {
        ...
        'Responsabilidad Civil': ['RC Extracontractual', 'RC Profesional', 'RC Directores y Administradores (D&O)', 'RC Clínicas'],
