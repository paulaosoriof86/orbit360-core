...
(function(){
  ...
  var state={initialized:false,activating:false,started:false,routerStarted:false,tenantContextReady:false,lastError:''};
  ...
  function activate(){
    ...
    state.activating=true;state.lastError='';state.tenantContextReady=false;
