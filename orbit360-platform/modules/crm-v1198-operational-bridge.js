...
Orbit.__crmV1198GuardDiagnostics = guardDiagnostics;
  ...
  function wrapRender(moduleName, moduleKey, after) {
    ...
    mod.render = function (host) {
      ...
      const currentStore = Orbit.store;
      const alreadyScoped = !!(currentStore && Object.prototype.hasOwnProperty.call(currentStore, '_scopedFor') && currentStore._scopedFor === moduleKey);
      const out = alreadyScoped ? original(host) : A.withScope(moduleKey, () => original(host));
