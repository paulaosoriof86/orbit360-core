...
if(pos('core/quote-comparison-contracts-v1203-refinements.js')<pos('core/quote-comparison-contracts-v1203.js'))errors.push('Refinamientos cargan antes del contrato base');
if(pos('core/quote-comparison-contracts-v1203-refinements.js')>pos('modules/cotizador-v1203-source-gate.js'))errors.push('Refinamientos cargan después del bridge');
...
const refine=read('core/quote-comparison-contracts-v1203-refinements.js');
...
if(!refine.includes('desglose_prima_no_cuadra')||!refine.includes('version_fuente_requerida'))errors.push('Falta validar desglose/version de fuente');
...
console.log('- desglose/version de fuente validados');
