...
if(pos('core/quote-comparison-contracts-v1203.js')<pos('modules/aseguradoras.js'))errors.push('Contrato cotizador carga antes de Aseguradoras/_fuentes');
...
if(!core.includes('CotizacionNormalizada')&&!core.includes('normalizeQuote'))errors.push('Falta contrato de cotización');
...
console.log('- DTOs canónicos persistidos mediante Orbit.store');
