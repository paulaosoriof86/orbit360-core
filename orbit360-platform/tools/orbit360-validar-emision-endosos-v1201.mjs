...
if (pos('modules/ops-workflows-v1201-bridge.js') < pos('modules/issuance-endosos-v1201-bridge.js')) errors.push('Bridge Ops carga antes del flujo de emisión');
...
const opsBridge = read('modules/ops-workflows-v1201-bridge.js');
...
if (!opsBridge.includes("c.def.nombre === 'Emisiones'") || !opsBridge.includes("kind: 'gestion'")) errors.push('Ops no mezcla solicitudes de emisión en la columna existente');
if (!opsBridge.includes("workflowType === 'issuance_request'")) errors.push('Ops no filtra el workflow de emisión');
...
console.log('- Solicitudes activas aparecen en la columna Emisiones existente');
