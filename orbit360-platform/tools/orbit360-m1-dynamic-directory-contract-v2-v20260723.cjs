...
const report = {
  schemaVersion: 'orbit360-m1-dynamic-directory-contract-v2',
  contractVersion: '1.0.40',
  status: failed.length ? 'DYNAMIC_DIRECTORY_CONTRACT_V2_FAILED' : 'DYNAMIC_DIRECTORY_CONTRACT_V2_PASS',
  ok: failed.length === 0,
  total: checks.length,
  ...
  checks,
  rootCauseCorrection: { unterminatedBootstrapCommentFixed:true, diagnosticCaptureMechanismIsolated:true },
...
const out = path.join(ROOT, 'runtime-gate-crm-v20260716/dynamic-directory-contract-v2-sanitized.json');
