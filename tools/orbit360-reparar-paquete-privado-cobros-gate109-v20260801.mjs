...
try{
 ...
 for(let i=0;i<pkg.cases.length;i++){
  ...
  if(mismatched.length===0)continue;if(!([3,4].includes(i+1)&&mismatched.length===1&&mismatched[0]==='endoso'&&expected.endoso===null&&typeof actual.endoso==='string'))throw new Error('DATA_CONTRACT_FAILURE:UNEXPECTED_MISMATCH_'+(i+1)+'_'+mismatched.join('_'));
