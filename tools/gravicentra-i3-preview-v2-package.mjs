...
for(const token of ['orbit360ProductInsurerCredentialCommand=onCall',"request=>execute(request,'firestore')"]) if(!backendText.includes(token))throw new Error('BACKEND_CONTRACT_MISSING:'+token);
