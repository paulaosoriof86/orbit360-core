...
need(files.crmBridge.includes("const scopedClients = scopedRows('clientes', 'cliente360')")&&files.crmBridge.includes("Orbit.clientProjection.project(c, { policyClientIds })"),'B2_R7_CLIENT_KPI_SECOND_WRITER_NOT_CANONICAL');
