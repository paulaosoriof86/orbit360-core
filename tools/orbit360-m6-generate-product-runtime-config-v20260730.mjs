...
try{
  ...
  writeEvidence({ok:true,status:'M6_PRODUCT_RUNTIME_CONFIG_DERIVED_READ_ONLY',projectIdentityMatches:true,webConfigDerivedReadOnly:true,webAppCount,tenantBound:true,collectionCount:runtime.collections.length,configWrittenToRunnerWorkspace:true,configCommitted:false,secretAccess:false,firestoreRead:false,operationalWrites:0});
