...
console.log(JSON.stringify({ok:true,classification:'FUNCTIONAL_DEFECT_FIXED_STATIC',policyAliases:true,vehicleAliases:true,indexedSummary:true,fullPagePolicy:true,fullPageVehicle:true,noUndefinedNaN:true,writes:0},null,2));
