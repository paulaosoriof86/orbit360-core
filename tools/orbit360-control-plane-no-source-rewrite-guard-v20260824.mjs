...
const out={schemaVersion:'orbit360-control-plane-no-source-rewrite-guard-v2',ok:failures.length===0,status:failures.length?'CONTROL_PLANE_NO_SOURCE_REWRITE_FAIL':'CONTROL_PLANE_NO_SOURCE_REWRITE_PASS',classification:failures.length?'PIPELINE_MECHANISM_FAILURE':'PASS',activePaths:ACTIVE,failures:[...new Set(failures)],runtimeExecuted:false,browserExecuted:false,secretAccess:false,firestoreRead:false,firestoreWrites:0,authWrites:0,operationalWrites:0,deployExecuted:false,productionTouched:false,containsPII:false,containsSecrets:false};
