...
}catch(error){result.status='POLICIES_CANONICAL_POSTWRITE_REVALIDATION_READONLY_FAIL';result.classification=text(error&&error.message).split(':')[0]||'DATA_CONTRACT_FAILURE';result.error=safeError(error);result.ok=false;}
