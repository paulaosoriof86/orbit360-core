...
try{
  ...
  if(f13.ok!==true||f13.status!=='F1_3_MEMBERSHIP_EMAIL_OWNERSHIP_SOURCE_ONLY_PASS'||f13.emailOptional!==true||f13.emailIdentityOwner!=='auth')throw new Error('F1_3_EVIDENCE_NOT_PASS');
