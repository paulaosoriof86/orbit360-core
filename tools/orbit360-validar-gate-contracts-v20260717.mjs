...
const GATE_CONFIG=Object.freeze({
  ...
  "block6-go-live-product-v20260730":{contractVersion:"6.3.0",lifecycle:"tools/orbit360-validator-lifecycle-contract-m6-final-closure-630-v20260730.json",engine:"tools/orbit360-validar-gate-contracts-engine-m6-final-closure-630-v20260730.mjs"}
});
