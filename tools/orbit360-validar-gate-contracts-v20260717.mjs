...
const GATE_CONFIG=Object.freeze({
  ...
  "block5-release-candidate-visualization-v20260728":{contractVersion:"5.0.16",lifecycle:"tools/orbit360-validator-lifecycle-contract-m5-runtime-smoke-516-v20260729.json",engine:"tools/orbit360-validar-gate-contracts-engine-m5-runtime-smoke-516-v20260729.mjs"}
});
