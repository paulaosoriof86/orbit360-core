...
const GATE_CONFIG=Object.freeze({
  ...
  "block5-release-candidate-visualization-v20260728":{contractVersion:"5.0.38",lifecycle:"tools/orbit360-validator-lifecycle-contract-m5-hosting-538-closed-v20260730.json",engine:"tools/orbit360-validar-gate-contracts-engine-m5-hosting-538-closed-v20260730.mjs"}
});
