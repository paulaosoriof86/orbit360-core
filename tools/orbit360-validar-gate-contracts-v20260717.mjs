...
const GATE_CONFIG=Object.freeze({
  ...
  "block5-release-candidate-visualization-v20260728":{contractVersion:"5.0.3",lifecycle:"tools/orbit360-validator-lifecycle-contract-m5-post-access-readiness-v20260728.json",engine:"tools/orbit360-validar-gate-contracts-engine-m5-post-access-readiness-v20260728.mjs"}
});
