...
const GATE_CONFIG=Object.freeze({
  ...
  "block6-go-live-product-v20260730":{contractVersion:"6.1.4",lifecycle:"tools/orbit360-validator-lifecycle-contract-m6-recovery-v20260730.json",engine:"tools/orbit360-validar-gate-contracts-engine-m6-recovery-v20260730.mjs"}
});
