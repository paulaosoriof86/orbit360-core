...
const ROUTER_VERSION = 'v10.8-f2-canonical-authority';
...
function f2CanonicalConfig() {
  ...
  if (!authority.gateContractVersion || !authority.lifecycles?.source || !authority.engine || !authority.sourcePhase) throw new Error('F2_CANONICAL_AUTHORITY_INCOMPLETE');
  return {
    contractVersion: authority.gateContractVersion,
    lifecycleComposition: authority.lifecycleComposition,
    lifecycle: authority.lifecycles.source,
    engine: authority.engine,
    defaultRequest: authority.requestBinding?.defaultRequest || '',
    sourcePhase: authority.sourcePhase,
