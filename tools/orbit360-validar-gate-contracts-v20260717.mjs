...
const GATE_CONFIG=Object.freeze({
  ...
  "block5-release-candidate-visualization-v20260728":{contractVersion:"5.0.4",lifecycle:"tools/orbit360-validator-lifecycle-contract-m5-lab-hosting-delivery-v20260728.json",engine:"tools/orbit360-validar-gate-contracts-engine-m5-lab-hosting-delivery-v20260728.mjs"}
});
