...
OUT="${ORBIT360_RESTORE_EVIDENCE:-orbit360-platform/runtime-gate-crm-v20260716/visual-matrix-v12-prior-hosting-restore-sanitized-v20260806.json}"
...
const value = {
  schemaVersion: 'orbit360-visual-matrix-v12-prior-hosting-restore-v1',
  gateId: 'block2.7-visual-matrix-corrected-post-auth-lab-v20260805',
  contractVersion: '2.7.8',
  requestVersion: '20260806.12-capture-watchdog-runtime',
...
KEY="${RUNNER_TEMP:-/tmp}/orbit360-visual-matrix-v12-restore-service-account.json"
...
rm -f "$KEY"
write_result 'STOP_PRIOR_HOSTING_RESTORE' 'ENVIRONMENT_FAILURE' 'V12_BASELINE_RESTORE_FAILED' false
exit 42
