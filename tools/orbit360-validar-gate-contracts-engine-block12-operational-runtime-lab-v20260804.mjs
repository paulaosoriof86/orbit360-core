...
try {
  ...
  add('LIFECYCLE_ACTIVE', lifecycle.status === 'OPERATIONAL_RUNTIME_LAB_BROWSER_HARNESS_ROOTFIX_READY' && lifecycle.singleGate === true && lifecycle.macroClosure === true);
