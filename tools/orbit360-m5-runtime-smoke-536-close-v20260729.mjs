...
const browser=read('m5-runtime-smoke-536-browser-summary.json');
const preflight=read('preflight-sanitizado.json');
const contract=read('m5-runtime-smoke-536-contract-summary.json');
