...
const REQUEST = process.env.ORBIT360_REQUEST_FILE || '.github/orbit360-requests/rc12-approved-roster-final-postrollback-v20260804.json';
...
try {
  ...
  add('LIFECYCLE_AUTHORIZED', lifecycle.status === 'RC12_APPROVED_ROSTER_FINAL_GO_LIVE_POST_ROLLBACK_AUTHORIZED' && lifecycle.singleGate === true && lifecycle.macroClosure === true);
