...
const expectedSourceSha='bc573f59651bec2dc438877fcb9f88caf3f026d4';
const sha=v=>crypto.createHash('sha256').update(v).digest('hex');
const allowed=['clientes','aseguradoras','asesores','polizas','vehiculos','recibosEsperados','carteraPrimas','cobros'];
const src=fs.readFileSync(source,'utf8');
if(sha(src)!==expectedSourceSha)throw new Error('SECURITY_CANDIDATE_SOURCE_DRIFT');
