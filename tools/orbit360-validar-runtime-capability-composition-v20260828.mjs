...
if(E.schemaVersion!=='orbit360-certified-product-entrypoint-contract-v1'||E.status!=='CERTIFIED_ARTIFACT_ENTRYPOINT_BASELINE_WITH_SUCCESSOR_OVERLAYS')fail('CERTIFIED_PRODUCT_ENTRYPOINT_CONTRACT_INVALID');
