...
function fieldEqual(actualValue,expectedValue){if(expectedValue==='SERVER_TIMESTAMP')return Boolean((actualValue&&typeof actualValue.toDate==='function')||(actualValue instanceof Date)||clean(actualValue));return JSON.stringify(comparable(actualValue??null))===JSON.stringify(comparable(expectedValue??null));}
