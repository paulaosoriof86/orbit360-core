...
import { evaluateF2StableBoundary, selfTestF2StableBoundary } from './orbit360-f2-stable-boundary-contract-v20260818.mjs';
...
const SOURCE_LIFECYCLE='tools/orbit360-validator-lifecycle-contract-f2-productive-acceptance-source-v20260818.json',RUNTIME_LIFECYCLE='tools/orbit360-validator-lifecycle-contract-f2-productive-acceptance-runtime-v20260818.json',RUNTIME_WORKFLOW='.github/workflows/orbit360-f2-productive-acceptance-runtime-browser-readonly-v20260818.yml',RUNTIME_EXECUTOR='tools/orbit360-f2-productive-acceptance-runtime-browser-readonly-v20260818.mjs',CANDIDATE_VALIDATOR='tools/orbit360-f2-exact-candidate-source-validator-v20260818.mjs',STABLE_BOUNDARY='tools/orbit360-f2-stable-boundary-contract-v20260818.mjs',LIVE='orbit360-platform/docs/orbit360-live-state-v1.json',INDEX='orbit360-platform/docs/ORBIT360-CURRENT-DOCUMENTATION-INDEX-v1.json',F1D='tools/orbit360-validator-lifecycle-contract-auth-paula-membership-readonly-reconcile-v2-f1-4d-v20260818.json';
