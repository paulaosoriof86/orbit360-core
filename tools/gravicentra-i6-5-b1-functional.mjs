// B1 governance trace: effective membership bootstrap owner bound in lock/control/guard.
// B1 trigger: contents-api push for causal product validation.
  ...
  try{
    ...
    const loginDiag=await loginPage.evaluate(async()=>{
      ...
      return {
        ...
        bootstrapAttachSnapshot:window.__b1AttachSnapshot||null,
        hash:location.hash
      };
    }).catch(e=>({diagnosticError:String(e?.message||e)}));
