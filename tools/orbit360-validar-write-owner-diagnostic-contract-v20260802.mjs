...
const checks=[
  ...
  {id:'ALL_WRITES_BLOCKED',ok:source.includes("throw new Error('RUNTIME_WRITE_GUARD:'+name)")},
  ...
  {id:'ROLE_AND_ROUTE_CAPTURED',ok:source.includes("role:Orbit.session&&Orbit.session.rol")&&source.includes("route:String(location.hash")},
