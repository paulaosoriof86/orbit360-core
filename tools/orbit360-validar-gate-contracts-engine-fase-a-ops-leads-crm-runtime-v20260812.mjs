...
const REQUEST=process.env.ORBIT360_REQUEST_FILE||'.github/orbit360-requests/fase-a-ops-leads-crm-release-v20260812-authorization.json';
...
try{
  ...
  add('EXTENSION_RUNTIME',extension.gateId===GATE&&extension.gateProfile==='fase-a-ops-leads-crm-runtime'&&extension.contractVersion===VERSION&&extension.lifecycle===LIFECYCLE&&extension.engine==='tools/orbit360-validar-gate-contracts-engine-fase-a-ops-leads-crm-runtime-v20260812.mjs');
  add('CANONICAL_ROUTER_RUNTIME',router.includes("const FASE_A_OPS_LEADS_CRM_RUNTIME_PROFILE = 'fase-a-ops-leads-crm-runtime';")&&router.includes("FASE_A_OPS_LEADS_CRM_RELEASE_READONLY_RUNTIME:")&&router.includes('FASE_A_OPS_LEADS_CRM_RUNTIME_CONFIG'));
