...
try{
 ...
 check('TEST_COVERAGE',test.includes('M4_DEFERRED')&&test.includes('QUERY_SOURCE_BLOCKED')&&test.includes('UNKNOWN_SOURCE_BLOCKED')&&test.includes('COUNTRY_CURRENCY_REQUIRED')&&test.includes('SECRETS_BLOCKED')&&test.includes('GENERIC_OWNER'));
