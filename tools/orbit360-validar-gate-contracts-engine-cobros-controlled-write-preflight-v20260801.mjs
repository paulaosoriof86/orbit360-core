...
function armedPayload(){
  ...
  if(request.privatePackage?.driveFileId!=='1FGpp_v6ZTs52VEeOnsH2IxoNCqWwVoAD'||request.privatePackage?.sha256!=='d64e64a01104be7defdc2c643b7180fe14ffa095f219aea9e13e6708c8bc1266'||request.privatePackage?.logicalSha256!=='1f06709e3c0a42534b17ff93809a3b527321552d68476267a2eb1ffe26a90036')throw new Error('AUTHORIZED_PACKAGE_MISMATCH');
