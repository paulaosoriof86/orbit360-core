...
const report={schemaVersion:'orbit360-m6-product-browser-smoke-v1',gateId:'block6-go-live-product-v20260730',contractVersion:'6.1.2',generatedAt:new Date().toISOString(),stage:'init',checks:{},roleViews:{},networkWriteCandidates:[],visibleTechnicalCopyPredicateVersion:VISIBLE_TECHNICAL_COPY_PREDICATE_VERSION,firestoreRead:true,firestoreWrites:0,operationalWrites:0,functionsDeploy:false,storageDeferredFailClosed:true,production:true,containsPII:false,containsSecrets:false};
