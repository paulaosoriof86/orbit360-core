...
const report={schemaVersion:'orbit360-m6-product-browser-smoke-v7',gateId:'block6-go-live-product-v20260730',contractVersion:'6.1.14',validatorRevision:'20260730.7',generatedAt:new Date().toISOString(),stage:'init',checks:{},roleViews:{},networkWriteCandidates:[],visibleTechnicalCopyPredicateVersion:VISIBLE_TECHNICAL_COPY_PREDICATE_VERSION,firestoreRead:true,firestoreWrites:0,operationalWrites:0,functionsDeploy:false,storageDeferredFailClosed:true,production:true,containsPII:false,containsSecrets:false};
...
try{
  ...
  report.stage='blocking_gates';
  const blockingGates=await settleBlockingGates(page,{arrivalWindowMs:1400,quietWindowMs:500,pollMs:80,hardTimeoutMs:5000,detachTimeoutMs:10000});
  report.blockingGateSettlement=blockingGates;
  need(blockingGates&&blockingGates.ok&&blockingGates.remaining===0,'BLOCKING_GATE_NOT_SETTLED',JSON.stringify(blockingGates||{}));
  report.checks.blockingGates=true;
