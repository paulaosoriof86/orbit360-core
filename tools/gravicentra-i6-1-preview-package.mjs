...
const payload={enabled:true,environmentRef:ENVIRONMENT_REF,tenantHint:TENANT_HINT,projectId:cfg.projectId,authDomain:cfg.authDomain,appId:cfg.appId,apiKey:cfg.apiKey,storageBucket:cfg.storageBucket||'',buildId,sourceSha:SOURCE_SHA,hydrationContractVersion:'fase-a-i2-20260919.5-team-canonical-required',hydrationContractSource:'recovery/fase-a-clean-20260831',requiredCollections:['clientes','polizas','cobros','aseguradoras','vehiculos','recibosEsperados','carteraPrimas','asesores'],optionalCollections:['estadosCuentaAseguradora','recibosAseguradora','conciliacionesPrimas','conciliaciones','metas','negocios','gestiones','comisiones','cancelaciones','auditoria']};
