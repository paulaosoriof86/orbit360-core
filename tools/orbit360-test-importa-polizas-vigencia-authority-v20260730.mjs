...
const activeVencida=Orbit.importaPolizasP0.normalizePolicy({
  numero:'POL-ACTIVA-001', aseguradoraNombre:'Demo', clienteNombre:'Cliente',
  vigenciaIni:'2026-01-01', vigenciaFin:'2026-12-31', estadoFuenteOriginal:'Vencida',
  pais:'GT', moneda:'GTQ', primaNeta:1000, formaPago:'Mensual'
},{today:'2026-07-30'});
...
const expiredVencida=Orbit.importaPolizasP0.normalizePolicy({
  numero:'POL-HIST-001', aseguradoraNombre:'Demo', clienteNombre:'Cliente',
  vigenciaIni:'2025-01-01', vigenciaFin:'2025-12-31', estadoFuenteOriginal:'Vencida',
  pais:'GT', moneda:'GTQ', primaNeta:1000, formaPago:'Mensual'
},{today:'2026-07-30'});
...
console.log(JSON.stringify({status:'PASS',vigenciaAuthority:true,sourceStatusPreserved:true,activeVencidaBecomesVigente:true,expiredVencidaStaysHistorical:true,firestoreWrites:0,operationalWrites:0},null,2));
