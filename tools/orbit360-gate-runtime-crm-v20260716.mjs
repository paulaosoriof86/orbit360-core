...
const report={schemaVersion:'orbit360-runtime-gate-joint-v22-router-owned-contract-queue',gateId:'block1-client360-insurers-lab-v20260717',contractVersion:'1.0.22',runtimeVersion:runtime,generatedAt:new Date().toISOString(),containsPII:false,containsSecrets:false,stage:'bootstrap',checks:{}};
