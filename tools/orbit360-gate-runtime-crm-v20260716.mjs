...
const report={schemaVersion:'orbit360-runtime-gate-joint-v18-product-bootstrap-readiness',gateId:'block1-client360-insurers-lab-v20260717',contractVersion:'1.0.10',runtimeVersion:runtime,generatedAt:new Date().toISOString(),containsPII:false,containsSecrets:false,stage:'bootstrap',checks:{}};
