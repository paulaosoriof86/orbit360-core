...
function sanitizeAdvisor(raw, advisorId) {
  ...
  return {
    ...
    dataScopes: scopes,
    teamId: text(raw.teamId || raw.equipoId, 160),
    equipoId: text(raw.teamId || raw.equipoId, 160),
    roleVisibleAdvisorIds: raw.roleVisibleAdvisorIds && typeof raw.roleVisibleAdvisorIds === 'object' ? raw.roleVisibleAdvisorIds : {},
    paises: countries,
...
function membershipShape(tenantId, uid, advisor) {
  return {
    ...
    equipoId: advisor.teamId || '',
    roleVisibleAdvisorIds: advisor.roleVisibleAdvisorIds || {},
