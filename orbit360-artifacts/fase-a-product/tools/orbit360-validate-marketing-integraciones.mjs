...
contains('core/integraciones.js', 'configurar(', 'configurar integracion tenant');
contains('core/integraciones.js', 'upsertIntegration', 'upsert integraciones');
contains('core/integraciones.js', 'integrationId', 'id estable por tenant/proveedor');
contains('core/integraciones.js', 'inputPersistedInFrontend: false', 'no persiste input sensible frontend');
contains('core/integraciones.js', 'backendRequired', 'backend requerido para secreto real');
contains('core/integraciones.js', 'pendiente_backend', 'estado pendiente backend');
